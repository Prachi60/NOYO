...
const SlideToPay = ({
    ...
    return (
        <div
            className="relative h-16 w-full rounded-full overflow-hidden select-none touch-none bg-linear-to-r from-[#45B0E2] via-[#0284c7] to-[#075985] shadow-[0_18px_45px_rgba(3,105,161,0.35)] border border-white/10"
        ...
        >
            ...
            >
                <span className="text-white font-black text-sm md:text-[13px] tracking-[0.25em] uppercase flex items-center gap-2">
                    {text} <span className="text-white/40">|</span> <span className="text-sky-50 font-extrabold">₹{amount}</span>
                </span>
            ...
            {/* Draggable Circle */}
            <motion.div
                className="absolute left-1 top-1 bottom-1 w-14 h-14 bg-white rounded-full flex items-center justify-center cursor-grab active:cursor-grabbing z-20 shadow-[0_6px_18px_rgba(3,105,161,0.25)] border border-sky-100"
