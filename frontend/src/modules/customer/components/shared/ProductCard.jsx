    ...
    return (
      <motion.div
        ...
        className={cn(
          ...
          compact
            ? "bg-white border-[1.5px] border-sky-50 shadow-[0_8px_20px_-8px_rgba(0,0,0,0.08)]"
            : neutralBg
              ? "bg-white border border-slate-100 shadow-[0_8px_20px_-8px_rgba(0,0,0,0.08)]"
              : "bg-[#f0f9ff] border border-sky-100",
          className,
        )}
        ...
        <div
          ...
          <div className="flex items-center gap-1.5 mb-1">
            <div
              className={cn(
                "border-2 border-sky-400 rounded-full flex items-center justify-center",
          ...
          <div className="flex items-center gap-1.5 text-gray-500 mt-1 mb-2">
            <Clock size={compact ? 10 : 11} className="text-sky-500/80" />
            <span
              className={cn(
                "font-semibold",
              ...
              {quantity > 0 ? (
                <div
                  ...
                  <button
                    ...
                    className="p-1 px-1.5 text-[#45B0E2] active:scale-90 transition-transform">
