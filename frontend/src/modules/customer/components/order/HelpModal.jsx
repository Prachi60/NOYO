                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <Link to="/support" className="col-span-2 py-3.5 rounded-xl border-2 border-[#45B0E2] text-[#45B0E2] font-bold flex items-center justify-center gap-2 hover:bg-green-50 transition-colors shadow-lg shadow-green-50">
