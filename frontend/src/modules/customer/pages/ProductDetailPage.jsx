                ...
                <div className="lg:w-[55%] xl:w-[60%] space-y-6 md:space-y-8">
                    <div>
                        ...
                        <div className="flex items-baseline gap-4 mb-5">
                            <span className="text-4xl font-black text-[#45B0E2]">₹{product.price}</span>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 p-6 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                        {quantity > 0 ? (
                            <div className="flex items-center bg-[#45B0E2] text-white rounded-2xl h-16 w-full sm:w-auto px-2 shadow-xl shadow-green-100">
                                <button
                            ...
                            <Button
                                ...
                                className="h-16 w-full sm:w-64 bg-[#45B0E2] hover:bg-[#0284c7] text-white text-lg font-black rounded-2xl shadow-xl shadow-green-100 transition-all hover:-translate-y-1"
                            >
                    ...
                    <div className="lg:w-[60%] space-y-8">
                        ...
                        {reviewLoading ? (
                            <div className="flex justify-center p-20">
                                <Loader2 className="animate-spin text-[#45B0E2]" size={32} />
                            </div>
                        ) : reviews.length > 0 ? (
