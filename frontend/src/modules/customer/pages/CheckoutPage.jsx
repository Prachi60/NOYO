...
const CheckoutPage = () => {
  ...
  if (cart.length === 0 && !showSuccess) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-sky-50/50 via-transparent to-transparent pointer-events-none" />
        <motion.div
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 90, 0],
          ...
          className="absolute -top-20 -right-20 w-80 h-80 bg-sky-100/30 rounded-full blur-3xl pointer-events-none"
        />
        <motion.div
          animate={{
            scale: [1, 1.5, 1],
        ...
        <motion.div className="relative z-10 flex flex-col items-center text-center max-w-sm mx-auto">
          ...
          <div className="relative w-56 h-56 md:w-64 md:h-64 mb-8 flex items-center justify-center">
            <motion.div
              ...
              className="relative z-10 rounded-[2rem] bg-white/90 p-6 shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-sky-100">
              <Lottie
          ...
          <Link
            to="/"
            className="group relative inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-[#45B0E2] to-[#10b981] text-white font-bold rounded-2xl overflow-hidden shadow-xl shadow-sky-600/20 transition-all hover:scale-[1.02] active:scale-95 w-full sm:w-auto">
  ...
  return (
    <div className="min-h-screen bg-[#f1f9fe] pb-32 font-sans">
      {/* Premium Header - Curved on mobile, integrated on desktop */}
      <div className="bg-gradient-to-br from-[#0369a1] via-[#0284c7] to-[#075985] pt-6 pb-12 md:pb-24 relative z-10 shadow-lg md:rounded-b-[4rem] rounded-b-[2rem] overflow-hidden">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-white/5 rounded-full blur-[100px] -mr-32 -mt-64 pointer-events-none" />
        <div className="absolute bottom-0 left-1/4 w-64 h-64 bg-sky-400/10 rounded-full blur-[80px] pointer-events-none" />
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <p className="text-sky-100/90 text-[10px] md:text-xs font-black tracking-[0.2em] uppercase">
          ...
          <div className="lg:col-span-7 xl:col-span-8 space-y-6 pb-8">
            ...
            <motion.div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 mt-3">
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 rounded-full bg-sky-50 flex items-center justify-center flex-shrink-0">
            ...
            <motion.div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
              ...
              {savedRecipient && !showRecipientForm && (
                <div className="mb-4 p-4 bg-sky-50 border border-sky-100 rounded-2xl flex items-start justify-between">
                  <div className="flex gap-3">
                    <div className="h-10 w-10 rounded-full bg-sky-100 flex items-center justify-center text-[#45B0E2] flex-shrink-0">
                      <Contact2 size={18} />
                    </div>
                    <div>
                  ...
                  <motion.div
                    ...
                    <div className="bg-[#f8f9fb] rounded-2xl p-4 border border-slate-100 space-y-4">
                      ...
                      <Button
                        ...
                        className="w-full h-12 bg-[#45B0E2] hover:bg-[#0284c7] text-white font-bold rounded-xl">
                        Save address
                      </Button>
                    </div>
                  </motion.div>
              ...
              {/* Address Card */}
              <div className="border rounded-xl p-3 mb-3 relative cursor-pointer transition-all border-[#45B0E2] bg-sky-50/50">
              ...
              <motion.div className="mt-3 rounded-2xl border border-sky-100 bg-sky-50/70 px-4 py-3 flex items-center gap-3 shadow-sm">
                <div className="h-8 w-8 rounded-full bg-sky-600 flex items-center justify-center shadow-sky-500/40 shadow-md">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 text-xs font-bold rounded-lg transition-colors ${
                        selectedCoupon?.code === coupon.code
                          ...
                          : "bg-[#45B0E2] text-white hover:bg-[#0284c7]"
                      }`}
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center px-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-black text-[#45B0E2] text-[13px] bg-sky-50 px-2 py-1 rounded-lg">
                      FREE
                    </span>
                  </div>
                </div>
                ...
                {selectedCoupon && (
                  <motion.div
                    ...
                    className="flex justify-between items-center px-3 py-2 bg-sky-50 rounded-xl border border-sky-100">
              ...
              <button
                ...
                className={`w-full p-4 rounded-2xl border-2 text-left transition-all ${
                  currentAddress.id === addr.id
                    ? "border-[#45B0E2] bg-sky-50 shadow-sm"
          ...
          <motion.div
            ...
            <DialogFooter className="mt-2">
              ...
              <Button
                ...
                className="bg-[#45B0E2] hover:bg-[#0284c7] text-white font-bold">
                Save changes
              </Button>
            </DialogFooter>
          </motion.div>
        ...
        {showSuccess && (
          <motion.div
            ...
            <motion.div
              ...
              className="w-24 h-24 bg-sky-100 rounded-full flex items-center justify-center text-[#45B0E2] mb-6">
            ...
            <motion.div
              ...
              className="w-48 h-1.5 bg-sky-100 rounded-full overflow-hidden">
