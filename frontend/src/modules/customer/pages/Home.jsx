...
const DEFAULT_CATEGORY_THEME = {
  gradient: "linear-gradient(to bottom, #45B0E2, #0284c7)",
  ...
  return (
    <div className="min-h-screen bg-[#F5F7F8] pt-[216px] md:pt-[250px]">
              ...
              {heroConfig.banners?.items?.length ? (
                ...
                <div
                  ...
                  <motion.div
                    ...
                    <div className="w-full h-[190px] bg-[#e0f2fe] p-6 relative overflow-hidden flex items-center border-y border-[#45B0E2]/10 shadow-[0_4px_15px_rgba(0,0,0,0.05)]">
      ...
      <div className="w-full -mt-[2px] md:-mt-[2px] mb-4">
        <div className="relative overflow-hidden border-y border-[#45B0E2]/20 bg-[#f0f9ff] shadow-[0_10px_30px_rgba(69,176,226,0.08)]">
          <div className="absolute inset-y-0 left-0 w-10 bg-gradient-to-r from-[#f0f9ff] via-[#f0f9ff]/90 to-transparent pointer-events-none" />
          <div className="absolute inset-y-0 right-0 w-10 bg-gradient-to-l from-[#f0f9ff] via-[#f0f9ff]/90 to-transparent pointer-events-none" />
          <div className="classic-marquee-track flex w-max items-center gap-4 px-3 md:px-6 py-4 text-sm md:text-base font-semibold text-[#0369a1] -translate-y-[4px]">
            {[...MARQUEE_MESSAGES, ...MARQUEE_MESSAGES].map((message, idx) => (
              <React.Fragment key={`${message}-${idx}`}>
                <span className="whitespace-nowrap">{message}</span>
                <span className="text-[#45B0E2]">•</span>
              </React.Fragment>
            ))}
            ...
            <div className="flex justify-between items-center mb-6 md:mb-10 px-1">
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-1.5 md:gap-2 mt-1.5 md:mt-3">
                  <div className="h-1 w-1 md:h-2 md:w-2 bg-[#45B0E2] rounded-full animate-pulse shadow-[0_0_8px_rgba(69,176,226,0.5)]" />
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-1 md:gap-2 bg-white px-3 py-1.5 md:px-6 md:py-3 rounded-full text-[#45B0E2] font-bold text-[10px] md:text-sm cursor-pointer shadow-sm md:shadow-lg border border-[#45B0E2]/5 transition-all">
                See all{" "}
                <ArrowRightIcon
