...
const CartPage = () => {
    ...
    return (
        <div className="relative isolate w-full overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(69,176,226,0.14),_transparent_34%),linear-gradient(180deg,_#f8faf9_0%,_#eef6f0_100%)] animate-in fade-in slide-in-from-bottom-4 duration-700">
