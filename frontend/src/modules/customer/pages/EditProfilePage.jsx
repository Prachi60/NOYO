            ...
            <div className="max-w-xl mx-auto p-5">
                ...
                <div className="flex flex-col items-center mb-8">
                    <div className="relative">
                        ...
                        <button className="absolute bottom-0 right-0 p-2 bg-[#45B0E2] text-white rounded-full border-2 border-white shadow-sm hover:bg-[#0284c7] transition-colors">
                            <Camera size={18} />
                        </button>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full py-4 bg-[#45B0E2] text-white font-bold rounded-2xl shadow-lg shadow-green-200 hover:bg-[#0284c7] active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                        {isLoading ? (
