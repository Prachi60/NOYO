    ...
    return (
        <div className="fixed inset-0 bg-white flex flex-col z-[999] overflow-hidden">
            ...
            <div className="bg-white p-3 border-t border-slate-100 shrink-0 z-30 safe-area-bottom relative mb-4">
                ...
                <div className="flex items-end gap-2 bg-slate-50 p-2 rounded-[1.5rem] border border-slate-200 focus-within:border-green-300 focus-within:shadow-[0_0_0_4px_rgba(69,176,226,0.1)] transition-all">
                    <button
                        onClick={() => setShowEmojiPicker(!showEmojiPicker)}
                        className={`p-2.5 rounded-full hover:text-slate-600 hover:bg-slate-200 transition-colors flex-shrink-0 ${showEmojiPicker ? 'text-[#45B0E2] bg-green-50' : 'text-slate-400'}`}
                    >
                        <Smile size={22} />
                    </button>
                    ...
                    <button
                        ...
                        className="p-2.5 rounded-full bg-[#45B0E2] text-white hover:bg-[#0284c7] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-green-200 flex-shrink-0"
                    >
