        ...
        if (this.state.hasError) {
            return (
                <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 font-outfit">
                    <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 text-center border border-gray-100">
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className="w-full bg-[#45B0E2] hover:bg-[#0284c7] text-white font-semibold py-3 px-6 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-green-100"
                            >
                    ...
                    <div className="mt-8 flex items-center gap-2 text-[#45B0E2] font-semibold">
